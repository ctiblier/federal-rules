...
**(v)** The witness must approve and sign the disclosure, unless the defendant: • states in the disclosure why the defendant could not obtain the witness’s signature through reasonable efforts; or • has previously provided under (F) a report, signed by the witness, that contains all the opinions and the bases and reasons for them required by (iii).
